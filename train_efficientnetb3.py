"""
EfficientNet-B3 Training Script - 3-Class Classification
"""
...
def create_working_model():
    """Create a fresh EfficientNetB3 model that will work"""
    
    print("Creating fresh EfficientNetB3 model...")
...
def train_working_model():
    ...
    print("SkinVestigator AI - Training EfficientNet-B3 (3-Class)")
    print("=" * 60)
    ...
    # Skip fine-tuning to save time - Phase 1 is sufficient
    print("Skipping fine-tuning phase to save time. Phase 1 training is sufficient.")
    # Save model and return
    model_path = "models/efficientnetb3_new.keras"
    ...
    with open("models/efficientnetb3_training_info.json", 'w') as f:
...
if __name__ == "__main__":
    ...
    if model:
        print(f"\n" + "="*60)
        print("SUCCESS: EfficientNet-B3 model trained and saved!")
