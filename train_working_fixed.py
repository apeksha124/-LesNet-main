"""
Fixed Working Model Training - Resolves the layer access error
"""
...
def train_working_model():
    ...
    print("SkinVestigator AI - Training Working Model (Fixed)")
    print("=" * 60)
    ...
    # Create data generators with your exact ImageDataGenerator settings
    ...
    # Phase 2: Fine-tuning - FIXED VERSION
    print("\nPhase 2: Fine-tuning top layers...")
    
    # Unfreeze top layers - FIXED
    # Access base model correctly through the functional model
    base_model = model.layers[0]  # The first layer is our base model
...
if __name__ == "__main__":
    ...
    if model:
        print(f"\n" + "="*60)
        print("SUCCESS: Working model trained and saved!")
